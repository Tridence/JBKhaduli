(function ($) {
    ...
    $(document).ready(function () {
        ...
        /* demo button */
        var $buythemediv = '<div class="buy-theme alt-font d-none d-lg-block"><a href="../index.html" target="_blank"><i class="ti-home"></i><span>HOME</span></a></div><div class="all-demo alt-font d-none d-lg-block"><a href="mailto:brianwanjalabarasa@gmail.com.com?subject=POFO - Creative Agency, Corporate and Portfolio Multi-purpose Template - Quick Question"><i class="ti-email"></i><span>Quick Question?</span></a></div>';
